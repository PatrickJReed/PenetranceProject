...
my $TCGA_List		= "/lustre/beagle2/preed/File_Paths_OVCA.txt";
my $Output_File1	= "/lustre/beagle2/preed/TCGA_OVCA_Freq.txt";
my $Output_File2	= "/lustre/beagle2/preed/TCGA_OVCA_Samp.txt";
my (@tmp1,@FILES);
my (%DATA1,%SAMPLES);
my $chr = "chr";
