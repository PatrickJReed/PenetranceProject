...
my $TCGA_List		= "/lustre/beagle2/preed/File_Paths_LIHC.txt";
my $Output_File1	= "/lustre/beagle2/preed/TCGA_LIHC_Freq.txt";
my $Output_File2	= "/lustre/beagle2/preed/TCGA_LIHC_Samp.txt";
my (@tmp1,@FILES);
my (%DATA1,%SAMPLES);
my $chr = "chr";
